package com.example.i_want_to_leave.login.oauth.service;

import com.example.i_want_to_leave.entity.User;
import com.example.i_want_to_leave.login.basic.service.BasicAuthenticationUserDetails;
import com.example.i_want_to_leave.login.oauth.dto.OAuth2AuthenticationDTO;
import com.example.i_want_to_leave.login.oauth.service.CustomOAuth2User;
import com.example.i_want_to_leave.login.oauth.service.response.FaceBookResponse;
import com.example.i_want_to_leave.login.oauth.service.response.GoogleResponse;
import com.example.i_want_to_leave.login.oauth.service.response.NaverResponse;
import com.example.i_want_to_leave.login.oauth.service.response.OAuth2Response;
